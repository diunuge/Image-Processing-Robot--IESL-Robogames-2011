...
function ssoGenerateLoginBar() {
  ...
  $r += '<div class="lo sep">|</div> ';
  $r += '<div class="lo"><a href="https://id.arduino.cc/auth/login/?returnurl=http%3A%2F%2Fwww.arduino.cc%2Fplayground%2FMain%2FInterfacingWithHardware">Sign in</a> or ';
  $r += '<a href="https://id.arduino.cc/auth/register/?returnurl=http%3A%2F%2Fwww.arduino.cc%2Fplayground%2FMain%2FInterfacingWithHardware">Register</a></div>';
  document.getElementById("loginInfo").innerHTML = $r;
}
