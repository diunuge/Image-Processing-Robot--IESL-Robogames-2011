...
void Susart_Init(unsigned short brg_reg) org 3796 {
  unsigned short i;
...
void Susart_Write(unsigned short data_) org 3748 {
...
unsigned short Susart_Data_Ready() org 3780 {
  return (PIR1.RCIF);
}

unsigned short Susart_Read() org 3484 {
  unsigned short rslt;
  rslt = RCREG;
...
void Start_Program() org 0x0FC0 {
}

void Flash_Write_Sector(long address, char *sdata) org 3560 {
...
unsigned short Susart_Write_Loop(char send, char receive) org 3676 {
...
//               location, in this case 3440
void Write_Begin() org 3510 {

  Flash_Write_Sector(0x0FC0, block);
  //--- goto main 3440
  block[0] = 0xB8;
  block[1] = 0xEF;
  block[2] = 0x06;
