...
void Susart_Init(unsigned short brg_reg) org 7886 {
  unsigned short i;
...
void Susart_Write(unsigned short data_) org 7842 {
...
unsigned short Susart_Data_Ready() org 7870 {
  return (PIR1.RCIF);
}

unsigned short Susart_Read() org 7810 {
  unsigned short rslt;
  rslt = RCREG;
...
void Start_Program() org 0x1FC0 {
}

void Flash_Write_Sector(long address, char *sdata) org 7630 {
...
unsigned short Susart_Write_Loop(char send, char receive) org 7572 {
...
//               location, in this case 7528
void Write_Begin() org 7754 {

  Flash_Write_Sector(0x1FC0, block);
  //--- goto main 7528
  block[0] = 0xB4;
  block[1] = 0xEF;
  block[2] = 0x0E;
