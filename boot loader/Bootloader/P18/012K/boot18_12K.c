...
void Susart_Init(unsigned short brg_reg) org 11982 {
  unsigned short i;
...
void Susart_Write(unsigned short data_) org 11940 {
...
unsigned short Susart_Data_Ready() org 11966 {
  return (PIR1.RCIF);
}

unsigned short Susart_Read() org 11908 {
  unsigned short rslt;
  rslt = RCREG;
...
void Start_Program() org 0x2FC0 {
}

void Flash_Write_Sector(long address, char *sdata) org 11734 {
...
unsigned short Susart_Write_Loop(char send, char receive) org 11678 {
...
//               location, in this case 11636;
void Write_Begin() org 11856 {

  Flash_Write_Sector(0x2FC0, block);
  //--- goto main 11636
  block[0] = 0xBA;
  block[1] = 0xEF;
  block[2] = 0x16;
