...
void Susart_Init(unsigned short brg_reg) org 16080 {
  unsigned short i;
...
void Susart_Write(unsigned short data_) org 16040 {
...
unsigned short Susart_Data_Ready() org 16066 {
  return (PIR1.RCIF);
}

unsigned short Susart_Read() org 16010 {
  unsigned short rslt;
  rslt = RCREG;
...
void Start_Program() org 0x3FC0 {
}

void Flash_Write_Sector(long address, char *sdata) org 15832 {
...
unsigned short Susart_Write_Loop(char send, char receive) org 15774 {
...
//               location, in this case 15732
void Write_Begin() org 15956 {

  Flash_Write_Sector(0x3FC0, block);
  //--- goto main 15732
  block[0] = 0xBA;
  block[1] = 0xEF;
  block[2] = 0x1E;
