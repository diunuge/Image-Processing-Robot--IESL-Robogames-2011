...
void Susart_Init(unsigned short brg_reg) org 24274 {
  unsigned short i;
...
void Susart_Write(unsigned short data_) org 24236 {
...
unsigned short Susart_Data_Ready() org 24260 {
  return (PIR1.RCIF);
}

unsigned short Susart_Read() org 24204 {
  unsigned short rslt;
  rslt = RCREG;
...
void Start_Program() org 0x5FC0 {
}

void Flash_Write_Sector(long address, char *sdata) org 24026 {
...
unsigned short Susart_Write_Loop(char send, char receive) org 23970 {
...
//               location, in this case 23928
void Write_Begin() org 24150 {

  Flash_Write_Sector(0x5FC0, block);
  //--- goto main 23928
  block[0] = 0xBC;
  block[1] = 0xEF;
  block[2] = 0x2E;
