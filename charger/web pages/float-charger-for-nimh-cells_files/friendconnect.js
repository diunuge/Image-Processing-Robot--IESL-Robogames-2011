...
window['___jsl'] = window['___jsl'] || {};window['___jsl']['u'] = 'http:\/\/www-a-fc-opensocial.googleusercontent.com\/gadgets\/js\/rpc:core.util.js?c=1';window['___jsl']['f'] = ['rpc','core.util'];
...
var gadgets=window.gadgets||{},shindig=window.shindig||{},osapi=window.osapi||{},google=window.google||{};
;
...
gapi.util.getOrigin=function(a){if(!a)return"";a=a.toLowerCase();a.indexOf("//")==0&&(a=window.location.protocol+a);a.indexOf("://")<0&&(a=window.location.protocol+"//"+a);var b=a.substring(a.indexOf("://")+3),c=b.indexOf("/");c!=-1&&(b=b.substring(0,c));var a=a.substring(0,a.indexOf("://")),c="",d=b.indexOf(":");if(d!=-1){var e=b.substring(d+1),b=b.substring(0,d);if(a==="http"&&e!=="80"||a==="https"&&e!=="443")c=":"+e}return a+"://"+b+c};
;
...
}function ac(af,ae,ag){if(!/http(s)?:\/\/.+/.test(ae)){if(ae.indexOf("//")==0){ae=window.location.protocol+ae
...
gadgets.rpc.init()
}else{gadgets.rpc=window.gadgets["rpc"];
...
window['___jsl']['l'] = (window['___jsl']['l'] || []).concat(['gapi-globals','globals','taming','core.config.base','core.log','gapi.util-globals','core.config','core.util.base','core.util.dom','core.util.event','core.util.onload','core.util.string','core.util.urlparams','gapi.util.getOrigin','core.json','core.util','rpc']);(function(){var j=window['___jsl'];if(j['c']&&--j['o']<=0){j['c']();delete j['c'];delete j['o'];}})();var friendconnect_serverBase = "http://www.google.com";var friendconnect_loginUrl = "https://www.google.com/accounts";var friendconnect_gadgetPrefix = "http://www-a-fc-opensocial.googleusercontent.com/gadgets";
...
google.friendconnect.container.setDateStamp_('13285634a7d');